...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.address_label_2 = QtWidgets.QLabel(self.tab1)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Historic")
        font.setPointSize(14)
        self.address_label_2.setFont(font)
        self.address_label_2.setObjectName("address_label_2")
        self.horizontalLayout_11.addWidget(self.address_label_2)
        self.admin_id = QtWidgets.QLineEdit(self.tab1)
        self.admin_id.setMinimumSize(QtCore.QSize(240, 40))
        self.admin_id.setMaximumSize(QtCore.QSize(240, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        self.admin_id.setFont(font)
        self.admin_id.setObjectName("admin_id")
        self.horizontalLayout_11.addWidget(self.admin_id)
        self.verticalLayout_2.addLayout(self.horizontalLayout_11)
        self.send_to_admin = QtWidgets.QPushButton(self.tab1)
        self.send_to_admin.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        self.send_to_admin.setFont(font)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/main/submit_document.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.send_to_admin.setIcon(icon1)
        self.send_to_admin.setIconSize(QtCore.QSize(32, 32))
        self.send_to_admin.setObjectName("send_to_admin")
        self.verticalLayout_2.addWidget(self.send_to_admin)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/main/send.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.send_logs.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/main/main_settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.tab.addTab(self.tab1, icon3, "")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/main/receipt.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.tab.addTab(self.tab2, icon4, "")
        self.tab3 = QtWidgets.QWidget()
        self.tab3.setObjectName("tab3")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/main/update.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.tab.addTab(self.tab3, icon5, "")
    ...
    def retranslateUi(self, Form):
        ...
        self.address_label_2.setText(_translate("Form", "Admin ID:"))
        self.admin_id.setPlaceholderText(_translate("Form", "123456789"))
        self.send_to_admin.setText(_translate("Form", "  Adminga ma\'lumot"))
