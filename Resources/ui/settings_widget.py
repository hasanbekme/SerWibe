...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.title_2.setText(_translate("Form", "Асосий созламалар"))
        self.company_name_2.setText(_translate("Form", "Авто бошлаш"))
        self.send_logs.setText(_translate("Form", "Дастурчиларга юбориш"))
        self.tab.setTabText(self.tab.indexOf(self.tab1), _translate("Form", "Асосий"))
        self.title.setText(_translate("Form", "Чек маълумотлари"))
        self.company_name.setText(_translate("Form", "Ташкилот номи:"))
        self.company_name_edit.setPlaceholderText(_translate("Form", "SerWibe"))
        self.address_label.setText(_translate("Form", "Манзил:"))
        self.number_label.setText(_translate("Form", "Telefon:"))
        self.number_edit.setInputMask(_translate("Form", "\\+\\9\\9\\8\\(99)-999-99-99"))
        self.tax_label.setText(_translate("Form", "Оффитсант учун:"))
        self.tax_label_2.setText(_translate("Form", "%"))
        self.last_message_label.setText(_translate("Form", "Охирги сатр:"))
        self.last_message_edit.setPlaceholderText(_translate("Form", "Tashrifingiz uchun raxmat."))
        self.last_message_label_2.setText(_translate("Form", "Касса принтер:"))
        self.p.setText(_translate("Form", "Принтер ўлчами:"))
        self.tax_label_4.setText(_translate("Form", "мм"))
        self.cancel_button.setText(_translate("Form", "Бекор қилиш"))
        self.accept_button.setText(_translate("Form", "Сақлаш"))
        self.tab.setTabText(self.tab.indexOf(self.tab2), _translate("Form", "Чек"))
        self.tab.setTabText(self.tab.indexOf(self.tab3), _translate("Form", "Янгилаш"))
import res_rc
