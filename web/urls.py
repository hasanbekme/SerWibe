...
urlpatterns = [
    ...
    path('product/raw/new', views.product_new, name="raw_product_new"),
    path('product/raw/<int:pk>/edit', views.raw_product_edit, name="raw_product_edit"),
    path('product/raw/<int:pk>/delete', views.raw_product_delete, name="raw_product_delete"),
    path('product/raw/<int:pk>/add', views.add_raw_to_stock, name="add_raw_to_stock"),
    ...
    path('rooms/<int:pk_room>/<int:pk_table>/edit', views.table_edit, name='table_edit'),
    ...
    path('archive/<int:pk>/view', views.archive_model_view, name='archive_order_view'),
