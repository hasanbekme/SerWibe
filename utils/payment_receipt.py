...
def print_receipt(order: Order):
    ...
    if Settings().get('has_company_logo', tp=bool):
        page.insert_image(
            image_path=f"{get_env()}\\company_logo.{Settings().get('company_logo', tp=str).split('.')[-1]}")
        page.br(5)
    ...
    if order.room_service_cost:
        ...
        page.set_font(family="courbd", size=16)
        page.text(f"{order.room_service_cost} {_('r_8')}", align="right", space=True)
        page.br(10)
    page.set_font(family="courbd", size=18)
...
def print_receipt_test(has_logo, logo_path, has_name, name, address, phone_number, for_waiter, last_message, printer,
                       printer_width):
    border_string = "-" * 200
    doc = Document(width=printer_width * 51, printer=printer)
    doc.begin_document()
    page = Receipt(width=printer_width * 80 - 400)
    if has_logo:
        page.insert_image(image_path=logo_path)
        page.br(5)
    if has_name:
        page.set_font(family="courbd", size=38)
        company_name = name
    ...
    if Settings().get("address", tp=str):
        page.set_font(family="courbd", size=12)
        page.text(f"{_('r_1')} " + address, space=True)
        page.br(5)
    if len(phone_number) != 17:
        page.text(f"{_('r_2')} " + phone_number, space=True)
        page.br(5)
    page.set_font(family="courbd", size=18)
    page.text(border_string, space=True)
    page.br(4)
    ...
    page.br(5)
    page.text(f"{_('r_3')}", align="left")
    page.text('#75', align="right", space=True)
    page.br(5)
    page.text(f"{_('r_4')}", align="left")
    page.text("Umumiy zal", align="right", space=True)
    page.br(5)
    page.text(f"{_('r_41')}", align="left")
    page.text("7", align="right", space=True)
    page.br(5)
    page.text(f"{_('r_6')}", align="left")
    page.text(f"Alimov B", align="right", space=True)
    page.br(5)
    page.text(border_string, space=True)
    page.br(4)
    page.set_font(family="courbd", size=22)
    ...
    page.br(5)
    page.set_font(family="courbd", size=15)
    page.text(f"4 x Gamburger", align="left")
    page.text(f"45 800 {_('r_8')}", align="right", space=True)
    page.br(5)
    page.text(f"2 x Pepsi 1.5l", align="left")
    page.text(f"14 200 {_('r_8')}", align="right", space=True)
    page.br(5)
    page.set_font(family="courbd", size=18)
    page.y -= 10
    page.text(border_string, space=True)
    ...
    page.text(f"{_('r_9')}", align="left")
    page.set_font(family="courbd", size=16)
    page.text(f"60 000 {_('r_8')}", align="right", space=True)
    page.br(10)
    page.set_font(family="courbd", size=18)
    page.text(f"{_('r_10')}", align="left")
    page.set_font(family="courbd", size=16)
    page.text(f"{for_waiter}%,(6000) {_('r_8')})", align="right", space=True)
    page.br(10)
    page.set_font(family="courbd", size=18)
    page.text(f"{_('r_11')}", align="left")
    page.set_font(family="courbd", size=16)
    page.text(f"10 000 {_('r_8')}", align="right", space=True)
    page.br(10)
    page.set_font(family="courbd", size=18)
    page.text(f"{_('r_12')}", align="left")
    page.text(f"76 000 {_('r_8')}", align="right", space=True)
    page.br(10)
    page.text(border_string, align="center", space=True)
    page.br(4)
    page.set_font(family="courbd", size=26)
    page.text(last_message, space=True)
    page.br(4)
    page.set_font(family="courbd", size=18)
    page.text(border_string, space=True)
    page.br(6)
